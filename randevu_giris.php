...
<head>
    ...
    <title>KAYIT OL / GİRİŞ YAP</title>
    <style>
        *,
        *:before,
        *:after {
...
<div class="cont">
    <div class="form sign-in">
        <h2>HOŞGELDİNİZ</h2>
        <form method="POST" action="randevu_giris.php">
            <input type="hidden" name="action" value="signin">
            <label>
                <span>E-mail'iniz</span>
    ...
    <div class="sub-cont">
        <div class="img">
            <div class="img__text m--up">
                <h3>Hesabın yok mu? Lütfen, kayıt ol!</h3>
            </div>
            <div class="img__text m--in">
                <h3>Hesabın varsa sadece giriş yapman yeter.</h3>
            </div>
            <div class="img__btn">
