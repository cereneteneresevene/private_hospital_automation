...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <a href="randevu_giris.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Kayıt</span> Ol</a>
    ...
    <section id="cta" class="cta">
        <div class="container" data-aos="zoom-in">
            ...
            <div class="text-center">
                ...
                <a class="cta-btn scrollto" href="randevu_giris.php">Randevu Almak İçin</a>
            </div>
