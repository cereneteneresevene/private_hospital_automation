...
<body id="page-top">
    ...
    <form action="departman_addget.php" method="post">
        <label for="department_name">Departman Adı:</label><br>
        <input type="text" id="department_name" name="department_name" required><br><br>
        <input type="submit" value="Departman Ekle">
    </form>
                <br>
                <?php
                if(isset($_GET['status']) && $_GET['status'] == 'success') {
                    echo '<div class="alert alert-success" role="alert">Departman başarıyla eklendi!</div>';
                }
                if(isset($_GET['status']) && $_GET['status'] == 'error') {
                    echo '<div class="alert alert-danger" role="alert">Hata: ' . $_GET['message'] . '</div>';
                }
                ?>
