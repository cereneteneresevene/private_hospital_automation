                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <h2>Doktor Ekle</h2>
                            <form action="doctor_addcode.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="departments">Bölüm:</label>
                            ...
                            if (isset($_GET['status'])) {
                                if ($_GET['status'] == 'success') {
                                    echo "<div class='alert alert-success'>Yeni doktor başarıyla eklendi</div>";
                                } else {
                                    echo "<div class='alert alert-danger'>Hata: " . $_GET['message'] . "</div>";
                                }
                            }
                            ?>
                        </div>
